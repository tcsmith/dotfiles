...
Register-ArgumentCompleter -Native -CommandName 'uv' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'uv' {
            ...
            [CompletionResult]::new('upgrade', 'upgrade', [CompletionResultType]::ParameterValue, 'Upgrade a dependency in the project')
            ...
            [CompletionResult]::new('check', 'check', [CompletionResultType]::ParameterValue, 'Run checks on the project')
        ...
        'uv;run' {
            ...
            [CompletionResult]::new('--no-group', '--no-group', [CompletionResultType]::ParameterName, 'Disable the specified dependency group [env: `UV_NO_GROUP`=]')
            ...
            [CompletionResult]::new('--no-editable-package', '--no-editable-package', [CompletionResultType]::ParameterName, 'Install the specified editable packages as non-editable')
            ...
            [CompletionResult]::new('--index', '--index', [CompletionResultType]::ParameterName, 'The indexes to use when resolving dependencies, in addition to the default index')
            [CompletionResult]::new('--default-index', '--default-index', [CompletionResultType]::ParameterName, 'The default package index (by default: <https://pypi.org/simple>)')
            ...
            [CompletionResult]::new('--no-sources-package', '--no-sources-package', [CompletionResultType]::ParameterName, 'Don''t use sources from the `tool.uv.sources` table for the specified packages [env: `UV_NO_SOURCES_PACKAGE`=]')
            [CompletionResult]::new('--no-build-package', '--no-build-package', [CompletionResultType]::ParameterName, 'Don''t build source distributions for a specific package [env: `UV_NO_BUILD_PACKAGE`=]')
            [CompletionResult]::new('--no-binary-package', '--no-binary-package', [CompletionResultType]::ParameterName, 'Don''t install pre-built wheels for a specific package [env: `UV_NO_BINARY_PACKAGE`=]')
            ...
            [CompletionResult]::new('--no-locked', '--no-locked', [CompletionResultType]::ParameterName, 'Disable locked mode, overriding `UV_LOCKED`')
            ...
            [CompletionResult]::new('--no-frozen', '--no-frozen', [CompletionResultType]::ParameterName, 'Disable frozen mode, overriding `UV_FROZEN`')
        ...
        'uv;add' {
            ...
            [CompletionResult]::new('--no-editable-package', '--no-editable-package', [CompletionResultType]::ParameterName, 'Don''t add the specified requirements as editable')
            ...
            [CompletionResult]::new('--no-install-project', '--no-install-project', [CompletionResultType]::ParameterName, 'Do not install the current project [env: UV_NO_INSTALL_PROJECT=]')
            ...
            [CompletionResult]::new('--no-install-workspace', '--no-install-workspace', [CompletionResultType]::ParameterName, 'Do not install any workspace members, including the current project [env: UV_NO_INSTALL_WORKSPACE=]')
            ...
            [CompletionResult]::new('--no-install-local', '--no-install-local', [CompletionResultType]::ParameterName, 'Do not install local path dependencies [env: UV_NO_INSTALL_LOCAL=]')
        ...
        'uv;sync' {
            ...
            [CompletionResult]::new('--no-install-project', '--no-install-project', [CompletionResultType]::ParameterName, 'Do not install the current project [env: UV_NO_INSTALL_PROJECT=]')
            [CompletionResult]::new('--only-install-project', '--only-install-project', [CompletionResultType]::ParameterName, 'Only install the current project')
            [CompletionResult]::new('--no-install-workspace', '--no-install-workspace', [CompletionResultType]::ParameterName, 'Do not install any workspace members, including the root project [env: UV_NO_INSTALL_WORKSPACE=]')
        ...
        'uv;lock' {
            ...
            [CompletionResult]::new('--frozen', '--frozen', [CompletionResultType]::ParameterName, 'Equivalent to `--check-exists`')
            [CompletionResult]::new('--no-frozen', '--no-frozen', [CompletionResultType]::ParameterName, 'Disable frozen mode, overriding `UV_FROZEN`')
        ...
        'uv;upgrade' {
            [CompletionResult]::new('--exclude', '--exclude', [CompletionResultType]::ParameterName, 'Exclude the named package from upgrades')
            [CompletionResult]::new('--cache-dir', '--cache-dir', [CompletionResultType]::ParameterName, 'Path to the cache directory')
            [CompletionResult]::new('--python-preference', '--python-preference', [CompletionResultType]::ParameterName, 'python-preference')
            [CompletionResult]::new('--python-fetch', '--python-fetch', [CompletionResultType]::ParameterName, 'Deprecated version of [`Self::python_downloads`]')
            [CompletionResult]::new('--color', '--color', [CompletionResultType]::ParameterName, 'Control the use of color in output')
        ...
        'uv;export' {
            ...
            [CompletionResult]::new('--no-group', '--no-group', [CompletionResultType]::ParameterName, 'Disable the specified dependency group [env: `UV_NO_GROUP`=]')
            [CompletionResult]::new('--only-group', '--only-group', [CompletionResultType]::ParameterName, 'Only include dependencies from the specified dependency group')
            [CompletionResult]::new('--no-editable-package', '--no-editable-package', [CompletionResultType]::ParameterName, 'Export the specified editable packages as non-editable')
            ...
            [CompletionResult]::new('--batch', '--batch', [CompletionResultType]::ParameterName, 'Export multiple selections from a TOML manifest containing `[[export]]` entries')
        ...
        'uv;check' {
            ...
            [CompletionResult]::new('-p', '-p', [CompletionResultType]::ParameterName, 'The Python interpreter to use for the project environment')
            [CompletionResult]::new('--python', '--python', [CompletionResultType]::ParameterName, 'The Python interpreter to use for the project environment')
            [CompletionResult]::new('--ty-version', '--ty-version', [CompletionResultType]::ParameterName, 'The version of ty to use for type checking')
            [CompletionResult]::new('--index', '--index', [CompletionResultType]::ParameterName, 'The indexes to use when resolving dependencies, in addition to the default index')
            [CompletionResult]::new('--default-index', '--default-index', [CompletionResultType]::ParameterName, 'The default package index (by default: <https://pypi.org/simple>)')
            [CompletionResult]::new('-i', '-i', [CompletionResultType]::ParameterName, '(Deprecated: use `--default-index` instead) The URL of the Python package index (by default: <https://pypi.org/simple>)')
            [CompletionResult]::new('--index-url', '--index-url', [CompletionResultType]::ParameterName, '(Deprecated: use `--default-index` instead) The URL of the Python package index (by default: <https://pypi.org/simple>)')
            ...
            [CompletionResult]::new('--project', '--project', [CompletionResultType]::ParameterName, 'Discover a project in the given directory')
            [CompletionResult]::new('--config-file', '--config-file', [CompletionResultType]::ParameterName, 'The path to a `uv.toml` file to use for configuration')
            [CompletionResult]::new('--fix', '--fix', [CompletionResultType]::ParameterName, 'Apply safe fixes to resolve type-checking errors')
            ...
            [CompletionResult]::new('--show-command', '--show-command', [CompletionResultType]::ParameterName, 'Display the ty command that will be used for type checking')
            [CompletionResult]::new('--no-project', '--no-project', [CompletionResultType]::ParameterName, 'Avoid discovering a project or workspace')
            [CompletionResult]::new('--no-index', '--no-index', [CompletionResultType]::ParameterName, 'Ignore the registry index (e.g., PyPI), instead relying on direct URL dependencies and those provided via `--find-links`')
            [CompletionResult]::new('-U', '-U ', [CompletionResultType]::ParameterName, 'Allow package upgrades, ignoring pinned versions in any existing output file. Implies `--refresh`')
            [CompletionResult]::new('--upgrade', '--upgrade', [CompletionResultType]::ParameterName, 'Allow package upgrades, ignoring pinned versions in any existing output file. Implies `--refresh`')
        ...
        'uv;audit' {
            ...
            [CompletionResult]::new('--no-group', '--no-group', [CompletionResultType]::ParameterName, 'Don''t audit the specified dependency group [env: `UV_NO_GROUP`=]')
            ...
            [CompletionResult]::new('--output-format', '--output-format', [CompletionResultType]::ParameterName, 'Select the output format')
            [CompletionResult]::new('--ignore', '--ignore', [CompletionResultType]::ParameterName, 'Ignore a vulnerability by ID')
            [CompletionResult]::new('--ignore-until-fixed', '--ignore-until-fixed', [CompletionResultType]::ParameterName, 'Ignore a vulnerability by ID, but only while no fix is available')
        ...
        'uv;tool' {
            ...
            [CompletionResult]::new('audit', 'audit', [CompletionResultType]::ParameterValue, 'Audit installed tools and their dependencies')
        ...
        'uv;tool;audit' {
            ...
            [CompletionResult]::new('--project', '--project', [CompletionResultType]::ParameterName, 'Discover a project in the given directory')
            [CompletionResult]::new('--config-file', '--config-file', [CompletionResultType]::ParameterName, 'The path to a `uv.toml` file to use for configuration')
            [CompletionResult]::new('--all', '--all', [CompletionResultType]::ParameterName, 'Audit all installed tools')
            [CompletionResult]::new('-n', '-n', [CompletionResultType]::ParameterName, 'Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation')
            [CompletionResult]::new('--no-cache', '--no-cache', [CompletionResultType]::ParameterName, 'Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation')
            [CompletionResult]::new('--managed-python', '--managed-python', [CompletionResultType]::ParameterName, 'Require use of uv-managed Python versions [env: UV_MANAGED_PYTHON=]')
            [CompletionResult]::new('--no-managed-python', '--no-managed-python', [CompletionResultType]::ParameterName, 'Disable use of uv-managed Python versions [env: UV_NO_MANAGED_PYTHON=]')
        ...
        'uv;pip' {
            [CompletionResult]::new('--cert', '--cert', [CompletionResultType]::ParameterName, 'Path to a PEM-encoded CA certificate bundle')
            [CompletionResult]::new('--cache-dir', '--cache-dir', [CompletionResultType]::ParameterName, 'Path to the cache directory')
            [CompletionResult]::new('--python-preference', '--python-preference', [CompletionResultType]::ParameterName, 'python-preference')
            [CompletionResult]::new('--python-fetch', '--python-fetch', [CompletionResultType]::ParameterName, 'Deprecated version of [`Self::python_downloads`]')
            [CompletionResult]::new('--color', '--color', [CompletionResultType]::ParameterName, 'Control the use of color in output')
        ...
        'uv;pip;install' {
            ...
            [CompletionResult]::new('--project', '--project', [CompletionResultType]::ParameterName, 'Discover a project in the given directory')
            [CompletionResult]::new('--config-file', '--config-file', [CompletionResultType]::ParameterName, 'The path to a `uv.toml` file to use for configuration')
            [CompletionResult]::new('--no-editable', '--no-editable', [CompletionResultType]::ParameterName, 'Install any editable dependencies as non-editable [env: UV_NO_EDITABLE=]')
            [CompletionResult]::new('--all-extras', '--all-extras', [CompletionResultType]::ParameterName, 'Include all optional dependencies')
            [CompletionResult]::new('--no-all-extras', '--no-all-extras', [CompletionResultType]::ParameterName, 'no-all-extras')
            [CompletionResult]::new('--no-index', '--no-index', [CompletionResultType]::ParameterName, 'Ignore the registry index (e.g., PyPI), instead relying on direct URL dependencies and those provided via `--find-links`')
            [CompletionResult]::new('-U', '-U ', [CompletionResultType]::ParameterName, 'Allow package upgrades, ignoring pinned versions in any existing output file. Implies `--refresh`')
        ...
        'uv;venv' {
            ...
            [CompletionResult]::new('--force', '--force', [CompletionResultType]::ParameterName, 'Allow `--clear` to remove a non-virtual environment directory')
        ...
        'uv;workspace;metadata' {
            ...
            [CompletionResult]::new('--locked', '--locked', [CompletionResultType]::ParameterName, 'Check if the lockfile is up-to-date [env: UV_LOCKED=]')
            [CompletionResult]::new('--no-locked', '--no-locked', [CompletionResultType]::ParameterName, 'Disable locked mode, overriding `UV_LOCKED`')
            [CompletionResult]::new('--frozen', '--frozen', [CompletionResultType]::ParameterName, 'Assert that a `uv.lock` exists without checking if it is up-to-date [env: UV_FROZEN=]')
            [CompletionResult]::new('--no-frozen', '--no-frozen', [CompletionResultType]::ParameterName, 'Disable frozen mode, overriding `UV_FROZEN`')
            [CompletionResult]::new('--dry-run', '--dry-run', [CompletionResultType]::ParameterName, 'Perform a dry run, without writing the lockfile')
            [CompletionResult]::new('--no-index', '--no-index', [CompletionResultType]::ParameterName, 'Ignore the registry index (e.g., PyPI), instead relying on direct URL dependencies and those provided via `--find-links`')
            [CompletionResult]::new('-U', '-U ', [CompletionResultType]::ParameterName, 'Allow package upgrades, ignoring pinned versions in any existing output file. Implies `--refresh`')
        ...
        'uv;cache;size' {
            ...
            [CompletionResult]::new('--project', '--project', [CompletionResultType]::ParameterName, 'Discover a project in the given directory')
            [CompletionResult]::new('--config-file', '--config-file', [CompletionResultType]::ParameterName, 'The path to a `uv.toml` file to use for configuration')
            [CompletionResult]::new('-H', '-H ', [CompletionResultType]::ParameterName, 'Display the cache size in human-readable format (e.g., `1.2GiB` instead of raw bytes)')
            [CompletionResult]::new('--human', '--human', [CompletionResultType]::ParameterName, 'Display the cache size in human-readable format (e.g., `1.2GiB` instead of raw bytes)')
            [CompletionResult]::new('-n', '-n', [CompletionResultType]::ParameterName, 'Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation')
            [CompletionResult]::new('--no-cache', '--no-cache', [CompletionResultType]::ParameterName, 'Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation')
            [CompletionResult]::new('--managed-python', '--managed-python', [CompletionResultType]::ParameterName, 'Require use of uv-managed Python versions [env: UV_MANAGED_PYTHON=]')
            [CompletionResult]::new('--no-managed-python', '--no-managed-python', [CompletionResultType]::ParameterName, 'Disable use of uv-managed Python versions [env: UV_NO_MANAGED_PYTHON=]')
